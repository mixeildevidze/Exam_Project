...
# deposit
list = ["deposit","withdraw","show balance", "exit"]
print(list)
...
if withdraw_money > updated_balance:
    ...
    print("განაღდება წარმატებით შესრულდა და ბალანსი შეადგენს" +  " " +  str(updated_balance) + " " + "ლარს")
